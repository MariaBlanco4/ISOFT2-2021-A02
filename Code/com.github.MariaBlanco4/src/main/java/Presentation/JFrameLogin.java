...
public class JFrameLogin extends JFrame {
	...
	public void login() {
		lblState.setText("");
		boolean result = LoginAgent.VerifyLogin(Integer.parseInt(txtfId.getText()), txtfName.getText(), txtfPosition.getText());
		if(result == false) {
			lblState.setText("Introduce again");
		}else {
			lblState.setText("Login success");
			if(txtfPosition.getText().equalsIgnoreCase("Room head")) {
				JFrame roomHead = new JFrame();
				roomHead.setVisible(true);
			}
		}
