...
import DomainDependencies.Control_operational_table;
...
public class JFrameRoomHead extends JFrame {
	...
	public void reserve() throws NumberFormatException, Exception {
		...
		int result = ReserveAgent.generate_reserve(state, txtfDateReserve.getText(), Integer.parseInt(txtfTableReserve.getText()), turn, n_chairs);		
		if(result == 0) {
	...
	public void change() throws NumberFormatException, Exception {
		...
		boolean result = Control_operational_table.changeState(state, Integer.parseInt(txtfTableState.getText()), txtfDateState.getText(), turn);
		if(result == false) {
	...
	public void setWaiter() throws NumberFormatException, Exception {
		...
		int result = ReserveAgent.setWaiter(txtfDateWaiter.getText(), Integer.parseInt(txtfTableWaiter.getText()), turn, Integer.parseInt(txtfWaiterWaiter.getText()));
		if(result == -1) {
